!function (o, s, r) {
    ...
    var l = r("body"), d = r(o), t = r('div[data-menu="menu-wrapper"]').html(),
    ...
    r.app.menu = {
        ...
        is_touch_device: function () {
            ...
            if ("ontouchstart" in o || o.DocumentTouch && s instanceof DocumentTouch) return !0;
            var n, a = ["(", e.join("touch-enabled),("), "heartz", ")"].join("");
            return n = a, o.matchMedia(n).matches
        },
        manualScroller: {
            obj: null, init: function () {
                r(".main-menu").hasClass("menu-dark");
                r.app.menu.is_touch_device() ? r(".main-menu").addClass("menu-native-scroll") : this.obj = new PerfectScrollbar(".main-menu-content", {
                    suppressScrollX: !0,
                    wheelPropagation: !1
                })
            }, update: function () {
                var e, n, a, i;
                !0 === r(".main-menu").data("scroll-to-active") && (i = s.querySelector(".main-menu-content li.active"), l.hasClass("menu-collapsed") ? r(".main-menu-content li.sidebar-group-active").length && (i = s.querySelector(".main-menu-content li.sidebar-group-active")) : (a = s.querySelector(".main-menu-content"), i && (e = i.getBoundingClientRect().top + a.scrollTop), e > parseInt(2 * a.clientHeight / 3) && (n = e - a.scrollTop - parseInt(a.clientHeight / 2))), setTimeout(function () {
                    r.app.menu.container.stop().animate({scrollTop: n}, 300), r(".main-menu").data("scroll-to-active", "false")
                }, 300))
            }, enable: function () {
        ...
        init: function (e) {
            var n;
            0 < r(".main-menu-content").length && (this.container = r(".main-menu-content"), n = !0 === e ? "collapsed" : "", l.data("menu"), this.change(n))
        },
        ...
        change: function (e) {
            ...
            "vertical-menu" !== s && "vertical-menu-modern" !== s || this.toOverlayMenu(n.name, s), l.is(".horizontal-layout") && !l.hasClass(".horizontal-menu-demo") && (this.changeMenu(n.name), r(".menu-toggle").removeClass("is-active")), "horizontal-menu" != s && this.drillDownMenu(n.name), "xl" == n.name && (r('body[data-open="hover"] .header-navbar .dropdown').on("mouseenter", function () {
                ...
                var e, n, a, i, s, t = r(this).find(".dropdown-menu");
                t && (e = r(o).height(), n = r(this).position().top, a = t.offset().left, i = t.width(), e - n - t.height() - 28 < 1 && (s = e - n - 170, r(this).find(".dropdown-menu").css({
                    "max-height": s + "px",
                    "overflow-y": "auto",
                    "overflow-x": "hidden"
                }), new PerfectScrollbar("li.dropdown-submenu.show .dropdown-menu", {wheelPropagation: !1})), 0 <= a + i - (o.innerWidth - 16) && r(this).addClass("openLeft"))
        ...
        changeMenu: function (e) {
            ...
            var n = r('div[data-menu="menu-wrapper"]'),
                ...
                i = r('li[data-menu="dropdown"]'), s = r('li[data-menu="dropdown-submenu"]');
        ...
        bind_events: function () {
            ...
            r(".navigation-main").on("mouseenter.app.menu", "li", function () {
                var e, n, a, i, s = r(this);
                r(".hover", ".navigation-main").removeClass("hover"), l.hasClass("menu-collapsed") && "vertical-menu-modern" != l.data("menu") && (r(".main-menu-content").children("span.menu-title").remove(), r(".main-menu-content").children("a.menu-title").remove(), r(".main-menu-content").children("ul.menu-content").remove(), e = s.find("span.menu-title").clone(), s.hasClass("has-sub") || (n = s.find("span.menu-title").text(), a = s.children("a").attr("href"), "" !== n && ((e = r("<a>")).attr("href", a), e.attr("title", n), e.text(n), e.addClass("menu-title"))), i = s.css("border-top") ? s.position().top + parseInt(s.css("border-top"), 10) : s.position().top, "vertical-compact-menu" !== l.data("menu") && e.appendTo(".main-menu-content").css({
                    position: "fixed",
                    top: i
                }), s.hasClass("has-sub") && s.hasClass("nav-item") && (s.children("ul:first"), t.adjustSubmenu(s))), s.addClass("hover")
                ...
                {
                    var e;
                    "vertical-menu-modern" == l.data("menu") && (r(".main-menu, .navbar-header").addClass("expanded"), l.hasClass("menu-collapsed") && (0 === r(".main-menu li.open").length && r(".main-menu-content").find("li.active").parents("li").addClass("open"), (e = r(".main-menu li.menu-collapsed-open")).children("ul").hide().slideDown(200, function () {
                        r(this).css("display", "")
                ...
                l.hasClass("menu-collapsed") && "vertical-menu-modern" == l.data("menu") && setTimeout(function () {
                    var e, n;
                    0 === r(".main-menu:hover").length && 0 === r(".navbar-header:hover").length && (r(".main-menu, .navbar-header").removeClass("expanded"), l.hasClass("menu-collapsed") && (n = (e = r(".main-menu li.open")).children("ul"), e.addClass("menu-collapsed-open"), n.show().slideUp(200, function () {
                        r(this).css("display", "")
                    }), e.removeClass("open")))
                }, 1)
        ...
        adjustSubmenu: function (e) {
            var n, a, i = e.children("ul:first"), s = i.clone(!0),
                t = (r(".main-menu-header").height(), e.position().top), o = d.height() - r(".header-navbar").height(),
                l = 0;
            i.height();
            0 < parseInt(e.css("border-top"), 10) && (l = parseInt(e.css("border-top"), 10)), a = o - t - e.height() - 30, r(".main-menu").hasClass("menu-dark"), n = t + e.height() + l, s.addClass("menu-popout").appendTo(".main-menu-content").css({
                top: n,
                position: "fixed",
                "max-height": a
            });
