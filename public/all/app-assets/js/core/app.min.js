!function (i, r, f) {
    "use strict";
    var e, a, t, n, s, c = f("html"), d = f("body"), h = "#ea5455";
    f(i).on("load", function () {
        ...
        !1 === f.app.nav.initialized && f.app.nav.init({speed: 300}), Unison.on("change", function (e) {
            f.app.menu.change()
        }), f('[data-toggle="tooltip"]').tooltip({container: "body"}), 0 < f(".navbar-hide-on-scroll").length && (f(".navbar-hide-on-scroll.fixed-top").headroom({
            offset: 205,
            tolerance: 5,
            ...
            var e, a = f(this).closest(".card").find(".card-content");
            e = d.hasClass("dark-layout") ? "#10163a" : "#fff", a.block({
        ...
        var t, n, s = f(".chartjs"), i = s.children("canvas").attr("height"), o = f(".main-menu");
        s.css("height", i), d.hasClass("boxed-layout") && d.hasClass("vertical-overlay-menu") && (t = o.width(), n = f(".app-content").position().left - t, d.hasClass("menu-flipped") ? o.css("right", n + "px") : o.css("left", n + "px")), f(".custom-file input").change(function (e) {
            f(this).next(".custom-file-label").html(e.target.files[0].name)
        }), f(".char-textarea").on("keyup", function (e) {
            !function (e, a) {
                var t = parseInt(f(e).data("length")), n = f(".counter-value"), s = f(".char-textarea");
                (function (e) {
                ...
                f(".char-count").html(e.value.length), e.value.length > t ? (n.css("background-color", h), s.css("color", h), s.addClass("max-limit")) : (n.css("background-color", "#7367f0"), s.css("color", "#4e5154"), s.removeClass("max-limit"))
    ...
    }), "undefined" != typeof Hammer && ("rtl" == f("html").data("textdirection") && (e = !0), a = r.querySelector(".drag-target"), t = "panright", n = "panleft", !0 === e && (t = "panleft", n = "panright"), 0 < f(a).length && new Hammer(a).on(t, function (e) {
    ...
    }, 300), s = r.querySelector(".sidenav-overlay"), 0 < f(s).length && new Hammer(s).on(n, function (e) {
        if (d.hasClass("vertical-overlay-menu")) return f.app.menu.hide(), !1
    ...
    }), f(".navigation").find("li").has("ul").addClass("has-sub"), f(".carousel").carousel({interval: 2e3}), f(".nav-link-expand").on("click", function (e) {
        ...
        var a = f(this), t = a.attr("href"), n = f(t).offset().top - 80;
        f("html, body").animate({scrollTop: n}, 0), setTimeout(function () {
        ...
        debug: !1,
        fallbackLng: "en",
        backend: {loadPath: "../../../app-assets/data/locales/{{lng}}.json"},
        returnObjects: !0
    }, function (e, a) {
        ...
        var a = e.text(), t = e.find(".flag-icon").attr("class");
    ...
    var o, v = f(".search-input input").data("search"), l = f(".bookmark-wrapper"),
        m = f(".bookmark-wrapper .bookmark-star"), g = f(".bookmark-wrapper .bookmark-input"),
        u = f(".nav-link-search"), C = f(".search-input"), k = f(".search-input input"),
        b = f(".search-input .search-list"), w = f(".app-content"), y = f(".bookmark-input .search-list");
    m.on("click", function (e) {
        e.stopPropagation(), g.toggleClass("show"), g.find("input").val(""), g.find("input").blur(), g.find("input").focus(), l.find(".search-list").addClass("show");
        var a = f("ul.nav.navbar-nav.bookmark-icons li"), t = "";
    ...
    }), f(".search-list-main").length && (o = new PerfectScrollbar(".search-list-main", {wheelPropagation: !1})), f(".search-list-bookmark").length && new PerfectScrollbar(".search-list-bookmark", {wheelPropagation: !1}), f(".search-list-main").mouseenter(function () {
        o.update()
        ...
        if (f(this).closest(".search-list").addClass("show"), 38 !== e.keyCode && 40 !== e.keyCode && 13 !== e.keyCode) {
            ...
            var s = f(this).val().toLowerCase(), i = "", o = !1;
            if (f("ul.search-list li").remove(), f(this).parent().hasClass("bookmark-input") && (o = !0), "" != s) {
                ...
                f.getJSON("../../../app-assets/data/" + v + ".json", function (e) {
                    for (var a = 0; a < e.listItems.length; a++) {
                        if (!0 === o) {
                            i = "";
                            for (var t = f("ul.nav.navbar-nav.bookmark-icons li"), n = 0; n < t.length; n++) {
                                if (e.listItems[a].name === t[n].firstChild.dataset.originalTitle) {
                                    i = " warning";
                                    break
                                }
                                i = ""
                        ...
                        0 == e.listItems[a].name.toLowerCase().indexOf(s) && p < 5 && (l += '<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer ' + (0 === p ? "current_item" : "") + '"><a class="d-flex align-items-center justify-content-between w-100" href=' + e.listItems[a].url + '><div class="d-flex justify-content-start align-items-center"><span class="mr-75 ' + e.listItems[a].icon + '" data-icon="' + e.listItems[a].icon + '"></span><span>' + e.listItems[a].name + "</span></div>" + m + "</a></li>", p++)
                    }
                    for (a = 0; a < e.listItems.length; a++) {
                        if (!0 === o) {
                            i = "";
                            for (t = f("ul.nav.navbar-nav.bookmark-icons li"), n = 0; n < t.length; n++) i = e.listItems[a].name === t[n].firstChild.dataset.originalTitle ? " warning" : "";
                            m = '<span class="float-right bookmark-icon feather icon-star' + i + '"></span>'
                        }
                        0 != e.listItems[a].name.toLowerCase().indexOf(s) && -1 < e.listItems[a].name.toLowerCase().indexOf(s) && p < 5 && (r += '<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer ' + (0 === p ? "current_item" : "") + '"><a class="d-flex align-items-center justify-content-between w-100" href=' + e.listItems[a].url + '><div class="d-flex justify-content-start align-items-center"><span class="mr-75 ' + e.listItems[a].icon + '" data-icon="' + e.listItems[a].icon + '"></span><span>' + e.listItems[a].name + "</span></div>" + m + "</a></li>", p++)
                    }
        ...
        if (e.stopPropagation(), f(this).hasClass("warning")) {
            ...
            var n = '<li class="nav-item d-none d-lg-block"><a class="nav-link" href="' + f(this).parent()[0].href + '" data-toggle="tooltip" data-placement="top" title="" data-original-title="' + f(this).parent()[0].innerText + '"><i class="ficon ' + f(this).parent()[0].firstChild.firstChild.dataset.icon + '"></i></a></li>';
            f("ul.nav.bookmark-icons").append(n), f('[data-toggle="tooltip"]').tooltip()
        }
    }), f(i).on("keydown", function (e) {
        var a, t, n, s = f(".search-list li.current_item");
        40 === e.keyCode ? (a = s.next(), s.removeClass("current_item"), s = a.addClass("current_item")) : 38 === e.keyCode && (t = s.prev(), s.removeClass("current_item"), s = t.addClass("current_item")), 13 === e.keyCode && 0 < f(".search-list li.current_item").length && (n = f(".search-list li.current_item a"), i.location = n.attr("href"), f(n).trigger("click"))
